...
If you already have a **GitHub account**, you can sign in and if you don't have one, you can create a new GitHub account by following the instructions below:  
  ...
  ***Mandatory for all***
  ...
  Step 1: Login to GitHub using your personal account. 
  Step 2: Once logged in, go to your [GitHub account settings](https://github.com/settings/emails).
  Step 3: In the left sidebar of the Settings page, click on "Emails."
  Step 4: In the "Primary email address" section, you should see your personal email address associated with your account. Below that, you can click on the "Add email address" button to add your school email address.
  Step 5: GitHub will send a verification email to your school email address. Check your school inbox, open the email, and click on the verification link provided.
...
Step 1: Access the Student Developer Pack:
...
Step 2: Select your academic status as Student. 
Step 3: Fill in the form and Click Continue. 
...
Step 2: Set your username and email, which will be associated with your commits. Use these commands, replacing "Your Name" and "your.email@example.com" with your actual information:

```
git config --global user.name "Your Name"
git config --global user.email your.email@example.com
```
Step 3: Check your Git Configuration 
```
git config --list
```
